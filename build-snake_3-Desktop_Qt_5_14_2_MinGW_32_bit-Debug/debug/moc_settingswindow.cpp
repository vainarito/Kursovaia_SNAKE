...
#include <memory>
#include "../../snake_3/settingswindow.h"
...
QT_MOC_LITERAL(1, 15, 15), // "backToPauseMenu"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 19) // "onBackButtonClicked"

    },
    "SettingsWindow\0backToPauseMenu\0\0"
    "onBackButtonClicked"
};
...
void SettingsWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->backToPauseMenu(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SettingsWindow::backToPauseMenu)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SettingsWindow::backToPauseMenu()
{
